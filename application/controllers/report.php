...
class Report extends Private_Controller {
	...
	public function factura_pdf()
	 ...
	 public function garantias_pdf()
	 {
		...
		<table cellpadding="0" cellspacing="0" border="0" style="text-align:left; vertical-align: middle; margin-top:20px;">
			<tr><td><h5><strong>Garant�as a efectuarse: </strong>'.($limit<1?"hoy":($limit==1?"Hasta ma�ana":"en ".$limit." d�as.")).'</h5></td></tr>
			<tr><td><h5><strong>Garant�as: </strong>'.$docs.'</h5></td></tr>
			<tr><td><h5><strong>Total garant�as: </strong>'.$garantias.'</h5></td></tr>
		</table>
		<br/>
		';
		$html = utf8_encode ($html);
		...
		// column titles
		$header = array('Fecha', 'Cliente', 'Veh�culo', 'Placa', 'Servicios');
	 ...
	 public function orden_pdf()
	{
		...
		<table cellpadding="0" cellspacing="0" style="border: 1px solid gray;">
			<table cellpadding="3" cellspacing="0" rules="none" border="0" style="font-size:11pt;">
				...
				<tr><td style="width:300px;"><strong>T�lefono:</strong> '.str_replace(array("{","}"),"",$cliente["cli_tel"]).'</td><td style="width:200px;"><strong>C.I./R.U.C.:</strong> '.$cliente["per_ced"].'</td></tr>
				<tr><td colspan="4"><strong>Direcci�n:</strong> '.utf8_decode($cliente["cli_dir"]).'</td></tr>
				<tr><td style="width:300px;"><strong>�Qui�n entrega?:</strong> '.utf8_decode($ordentrb["ord_per_ent"]).'</td><td style="width:200px;"><strong>Tel�fono:</strong> '.$ordentrb["ord_per_tel"].'</td></tr>
		...
		<table cellpadding="0" cellspacing="0" style="border: 1px solid gray;">
			<table cellpadding="3" cellspacing="0" rules="none" border="0" style="font-size:11pt;">
				...
				<tr><td><strong>Chas�s:</strong> '.$vehiculo["veh_cha"].'</td><td ><strong>Placa:</strong> '.$vehiculo["veh_pla"].'</td></tr>
				<tr><td><strong>A�o:</strong> '.$vehiculo["veh_yar"].'</td><td ><strong>Motor:</strong> '.$vehiculo["veh_mot"].'</td></tr>
				<tr><td><strong>Color:</strong> <span style="background-color:'.$vehiculo["veh_col"].';">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span></td><td><strong>C�digo:</strong> '.$vehiculo["veh_cla"].'</td></tr>
			</table>
		</table>
		<br/>
		<br/>
		...
		<table cellpadding="0" cellspacing="0" border="0">
			...
			<tr><td align="center">RECIB� CONFORME</td><td align="center">ENTREGU� CONFORME</td></tr>
			<tr><td align="center" colspan="2"><small><strong>IMPORTANTE:</strong> No nos responsabilizamos por obejtos de valor en su vehiculo, que no est�n relacionados con la orden de trabajo.</small></td></tr>
		</table>
		';
